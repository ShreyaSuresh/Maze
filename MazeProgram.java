...
public class MazeProgram extends JPanel implements KeyListener,MouseListener
{
	...
	public MazeProgram()
	{
		...
		try{
			AudioInputStream audioStream = AudioSystem.getAudioInputStream(new File("mazeMusic.wav"));
	...
	public void paintComponent(Graphics g)
	{
		...
		if(x == lastY && y == 15){
			g.setFont(new Font("Stencil",Font.PLAIN,40));
			g.setColor(Color.WHITE);
			g.fillRect(0,0,1500,800);
	...
	public void setBoard()
	{
		...
		File name = new File("MazeFile.txt");
		try
		{
